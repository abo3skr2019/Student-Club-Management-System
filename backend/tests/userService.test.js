...
describe("userService", () => {
  ...
  describe("findByUUID", () => {
    ...
    it("should throw error if UUID is not provided", async () => {
      await expect(userService.findByUUID()).rejects.toThrow(
        "UUID is required"
      );
    });
  });
  ...
  describe("findByRole", () => {
    ...
    it("should throw error if role is not provided", async () => {
      await expect(userService.findByRole()).rejects.toThrow(
        "Role is required"
      );
    });
  });
  ...
  describe("updateProfile", () => {
    ...
    it("should throw error if user not found", async () => {
      ...
      await expect(
        userService.updateProfile("123", { firstName: "John" })
  ...
  describe("changeRole", () => {
    ...
    it("should throw error for invalid role", async () => {
      await expect(
        userService.changeRole("123", "InvalidRole")
  ...
  describe("joinClub", () => {
    ...
    it("should throw error if club not found", async () => {
      ...
      await expect(userService.joinClub("123", "456")).rejects.toThrow(
        "Club not Found"
      );
    });
  });
  ...
  describe("leaveClub", () => {
    ...
    it("should throw error if user is not a member of the club", async () => {
      ...
      await expect(userService.leaveClub("123", "456")).rejects.toThrow(
  ...
  describe("findByClubsJoined", () => {
    ...
    it("should throw error if clubId is not provided", async () => {
      await expect(userService.findByClubsJoined()).rejects.toThrow(
        "clubId is required"
      );
    });
  });
  ...
  describe("findByClubsManaged", () => {
    ...
    it("should throw error if clubId is not provided", async () => {
      await expect(userService.findByClubsManaged()).rejects.toThrow(
        "clubId is required"
      );
    });
  });
  ...
  describe("findByEventsJoined", () => {
    it("should throw not implemented error", async () => {
      await expect(userService.findByEventsJoined("123")).rejects.toThrow(
  ...
  describe("findUserEvents", () => {
    it("should throw not implemented error", async () => {
      await expect(userService.findUserEvents("123")).rejects.toThrow(
        "Events are not implemented yet"
      );
    });
  });
